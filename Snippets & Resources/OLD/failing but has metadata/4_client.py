...
from Utility_Functions.generalFunctions import get_private_ip
...
clientPrivateIP = get_private_ip()
...
if camera:
    ...
    camera_name = socket.gethostname() # get hostname of the pc
...
if client_socket:
    while vid.isOpened():
        try:
            ...
            # print(f'img: {img}') # debug, print out image
