...
# ADD OPtions to name the camera and location
# this one will only take commands from the console, we should add an option so it can toggle displaying a video feed (so low power machines don't chug)
